...
// GET
// ===============================
func ByHostgroup(host string, hg string, ss *models.Session) models.Response {
	uri := fmt.Sprintf("hostgroups/%s/hosts?format=json&per_page=%d", hg, ss.Config.Api.GetPerPage)
...
func ByHostgroupName(hgName string, params url.Values, ss *models.Session) map[string][]models.Host {
...
func ByHostgroupNameHostNames(hgName string, params url.Values, ss *models.Session) map[string][]string {
	var r HResult
	r.Init()

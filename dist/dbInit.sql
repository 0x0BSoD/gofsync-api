...
ALTER TABLE `goFsync`.`environments`
    AUTO_INCREMENT = 0;
ALTER TABLE `goFsync`.`hg`
    AUTO_INCREMENT = 0;
ALTER TABLE `goFsync`.`hg_parameters`
    AUTO_INCREMENT = 0;
ALTER TABLE `goFsync`.`locations`
    AUTO_INCREMENT = 0;
ALTER TABLE `goFsync`.`override_values`
    AUTO_INCREMENT = 0;
ALTER TABLE `goFsync`.`puppet_classes`
    AUTO_INCREMENT = 0;
ALTER TABLE `goFsync`.`smart_classes`
    AUTO_INCREMENT = 0;
